...
//            final ResponseEntity<Library> response=restTemplate.getForEntity("api/library/lister-by-id/1" , Library.class);
        ...
        void test_create_1() {
            ...
            final LibraryDto mantional_library_montreuil_dto =
                    new LibraryDto(0, DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getType(),
                            new AddressDto(DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getAddress().getNumber(),
                                    DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getAddress().getStreet(),
                                    DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getAddress().getZipcode(),
                                    DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getAddress().getCity()),
                            new DirectorDto(
                                    DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getDirector().getFirstname(),
                                    DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getDirector().getLastname()),
                            DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getBooks().stream().map(book -> new BookDto(book.getIsbn(), book.getTitle(),
            ...
            // TODO : Check equality
            assertThat(libraryFromDB.get().getType()).isEqualTo(DatabaseTestHelper.NATIONAL_LIBRARY_MONTREUIL.getType());
        ...
        class Test_update {
            ...
            void test_update_1() {
                ...
                // --------------- When ---------------
                final LibraryDto schoolLibraryParisDTO = new LibraryDto(DatabaseTestHelper.SCHOOL_LIBRARY_PARIS.getType()
                        , new AddressDto(
                        DatabaseTestHelper.SCHOOL_LIBRARY_PARIS.getAddress().getNumber(), DatabaseTestHelper.SCHOOL_LIBRARY_PARIS.getAddress().getStreet(),
                        DatabaseTestHelper.SCHOOL_LIBRARY_PARIS.getAddress().getZipcode(), DatabaseTestHelper.SCHOOL_LIBRARY_PARIS.getAddress().getCity()),
                        new DirectorDto(DatabaseTestHelper.SCHOOL_LIBRARY_PARIS.getDirector().getLastname(),
                                DatabaseTestHelper.SCHOOL_LIBRARY_PARIS.getDirector().getFirstname()),
                        DatabaseTestHelper.SCHOOL_LIBRARY_PARIS
                ...
                // TODO : Check equality
                assertThat(libraryFromDB.get().getType()).isEqualTo(DatabaseTestHelper.SCHOOL_LIBRARY_PARIS.getType());
            }
            @Test
